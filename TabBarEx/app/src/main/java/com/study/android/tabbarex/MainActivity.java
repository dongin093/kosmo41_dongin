...
//    public void getString(Intent intent) {
...
//
//        getXmlData(pass1,pass2);
//    }
//
//    //검색명 입력하면 입력된 검색데이터 송출
//    public void getXmlData(String pass1,String pass2){
//
//        StringBuffer buffer=new StringBuffer();
//
//        String location1 = URLEncoder.encode(pass1);//한글의 경우 인식이 안되기에 utf-8 방식으로 encoding..
//        String location2 = URLEncoder.encode(pass2);
//
//        try {
